...
import { 
    Calendar, Plus, Trash2, CalendarOff, Palmtree, MapPin, Phone, Info, X, UserX,
...
const ExpertCalendar = ({
    ...
    return (
        <div style={{ position: 'relative' }}>
            ...
            {/* MERKINNÄN TIEDOT / POISTO MODAALI */}
            {selectedBlock && (
            ...
            <Card title="Asiantuntijan kalenteriruudukko (Liukumat 07:00 - 19:00)" icon={Calendar}>
                            ...
                            return (
                                <div 
                                    ...
                                    style={{ 
                                        ...
                                        ...baseStyle,
                                        backgroundColor: isInternalWork ? 'rgba(241, 245, 249, 0.6)' : 'rgba(248, 250, 252, 0.4)', 
                                        border: isInternalWork ? '1px dashed #94a3b8' : `1px dashed ${baseStyle.color}`,       
                                        color: isInternalWork ? '#64748b' : baseStyle.color, 
                                        margin: '2px', 
                                        borderRadius: '4px', 
